...
interface AuthRepository {
    ...
    suspend fun register(email: String, password: String,fullName: String): Flow<TasstyResponse<AuthUser>>
    suspend fun verify(email: String, verifyCode: String): Flow<TasstyResponse<String>>
}