...
//        val response = TasstyResponse.Loading<String>()
...
//        val mockMeta = Meta(message = "Jaringan bermasalah", status = 400)
//        val response = TasstyResponse.Error<String>(meta = mockMeta)
//
//        val result = response.mapToResource { it.length }
//
